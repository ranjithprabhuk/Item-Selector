...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_forms__ = __webpack_require__(395);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_common__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__item_selector_component__ = __webpack_require__(398);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__item_selector_routing_module__ = __webpack_require__(400);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ngui_auto_complete__ = __webpack_require__(403);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ItemSelectorModule", function() { return ItemSelectorModule; });
...
var ItemSelectorModule = (function () {
    function ItemSelectorModule() {
    }
    return ItemSelectorModule;
}());
ItemSelectorModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        imports: [
            __WEBPACK_IMPORTED_MODULE_4__item_selector_routing_module__["a" /* ItemSelectorRoutingModule */],
            __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormsModule"],
            __WEBPACK_IMPORTED_MODULE_2__angular_common__["CommonModule"],
            __WEBPACK_IMPORTED_MODULE_5__ngui_auto_complete__["NguiAutoCompleteModule"]
        ],
        declarations: [__WEBPACK_IMPORTED_MODULE_3__item_selector_component__["a" /* ItemSelectorComponent */]]
    })
], ItemSelectorModule);

//# sourceMappingURL=item-selector.module.js.map
...
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rxjs_observable_forkJoin__ = __webpack_require__(408);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_observable_fromPromise__ = __webpack_require__(177);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_observable_fromPromise___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_rxjs_observable_fromPromise__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_operator_map__ = __webpack_require__(174);
...
var auto_complete_1 = __webpack_require__(397);
/**
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__item_selector_service__ = __webpack_require__(401);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ItemSelectorComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ItemSelectorComponent = (function () {
    function ItemSelectorComponent(_itemSelectorService) {
        this._itemSelectorService = _itemSelectorService;
        this.itemList = [];
    ...
    ItemSelectorComponent.prototype.addProduct = function (product) {
        if (product) {
    ...
    ItemSelectorComponent.prototype.removeProduct = function (index) {
        this.selectedProducts.splice(index, 1);
    };
    //format the data to list in the auto complete
    ItemSelectorComponent.prototype.autocompleListFormatter = function (data) {
        return "" + data['productName'];
    };
    //on value selected from the dropdown and reset the dropdown
    ItemSelectorComponent.prototype.onSelect = function (value) {
        this.resetSearchBox();
        this.addProduct(value);
    };
    //reset the input value
    ItemSelectorComponent.prototype.resetSearchBox = function () {
        this.product = "";
    };
    //check the category is the selected one in the list
    ItemSelectorComponent.prototype.isSelecetdCategory = function (category, selected) {
        return category.categoryId == selected.categoryId ? true : false;
    };
    //reset the added product grid
    ItemSelectorComponent.prototype.clearAddedProducts = function () {
        this.selectedProducts = [];
    };
    //get the data from the service
    ItemSelectorComponent.prototype.getCategories = function () {
        var _this = this;
        this._itemSelectorService.getCategories().then(function (res) {
            _this.itemList = JSON.parse(res);
            _this.selectedCategory = _this.itemList[0]; //by default select the first array
        }).catch(function (err) {
...
ItemSelectorComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_1__item_selector_service__["a" /* ItemSelectorService */]]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__item_selector_service__["a" /* ItemSelectorService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__item_selector_service__["a" /* ItemSelectorService */]) === "function" && _a || Object])
], ItemSelectorComponent);

var _a;
//# sourceMappingURL=item-selector.component.js.map
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__(1);
var auto_complete_component_1 = __webpack_require__(396);
var forms_1 = __webpack_require__(395);
/**
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__item_selector_component__ = __webpack_require__(398);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ItemSelectorRoutingModule; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    {
        path: '',
        component: __WEBPACK_IMPORTED_MODULE_2__item_selector_component__["a" /* ItemSelectorComponent */],
        data: {
            title: 'Item Selector'
        }
    }
];
var ItemSelectorRoutingModule = (function () {
    function ItemSelectorRoutingModule() {
    }
    return ItemSelectorRoutingModule;
}());
ItemSelectorRoutingModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
...
//# sourceMappingURL=item-selector-routing.module.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__app_service__ = __webpack_require__(175);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_toPromise__ = __webpack_require__(176);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_toPromise___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_toPromise__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ItemSelectorService; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ItemSelectorService = (function () {
    function ItemSelectorService(apiService) {
        this.apiService = apiService;
        this.apiEndPoint = "/assets/json/";
    }
    //to get the Data from the static json file
    ItemSelectorService.prototype.getCategories = function (parameter) {
...
ItemSelectorService = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__app_service__["a" /* ApiService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__app_service__["a" /* ApiService */]) === "function" && _a || Object])
], ItemSelectorService);

var _a;
//# sourceMappingURL=item-selector.service.js.map
...
var forms_1 = __webpack_require__(395);
var auto_complete_component_1 = __webpack_require__(396);
var auto_complete_directive_1 = __webpack_require__(399);
var auto_complete_1 = __webpack_require__(397);
...
var auto_complete_module_1 = __webpack_require__(402);
...
module.exports = "<div class=\"animated fadeIn\">\r\n  <!--/.row-->\r\n  <div class=\"row\">\r\n\r\n    <div class=\"col-md-3\">\r\n      <ul class=\"list-group\">\r\n        <li class=\"list-group-item\">Categories</li>\r\n        <li class=\"list-group-item cursor\" [ngClass]=\"{'active' : isSelecetdCategory(category,selectedCategory)}\" *ngFor=\"let category of itemList\"\r\n          (click)=\"selectedCategory=category;\">{{category.categoryName}}\r\n          <span class=\"badge badge-info badge-pill pull-right\">{{category.products.length}}</span>\r\n        </li>\r\n      </ul>\r\n    </div>\r\n\r\n    <div class=\"col-md-6\">\r\n      <div class=\"card\">\r\n        <div class=\"card-header\">\r\n          <div class=\"row\">\r\n            <div class=\"col-md-6\">\r\n              <input class=\"form-control\" auto-complete [(ngModel)]=\"product\" (valueChanged)=\"onSelect($event);\" value-property-name=\"productId\"\r\n                display-property-name=\"productName\" [list-formatter]=\"autocompleListFormatter\" [source]=\"selectedCategory.products\"\r\n              />\r\n            </div>\r\n            <div class=\"col-md-6\">\r\n              <h6 class=\"float-right\"><span class=\"badge badge-warning\">Product List</span></h6>\r\n            </div>\r\n          </div>\r\n        </div>\r\n        <div class=\"card-block\">\r\n          <div class=\"row\">\r\n            <div class=\"col-md-4 cursor\" *ngFor=\"let product of selectedCategory.products\" (click)=\"addProduct(product);\">\r\n              <div class=\"btn btn-outline-primary btn-block\">\r\n                <div class=\"col-xs-12 fa fa-cubes fa-3x\"></div>\r\n                <h6 class=\"col-12\">{{product.productName}}</h6>\r\n                <button class=\"btn btn-success btn-sm\">+ Add</button>\r\n              </div>\r\n            </div>\r\n          </div>\r\n        </div>\r\n      </div>\r\n    </div>\r\n    <div class=\"col-md-3\">\r\n      <ul class=\"list-group\">\r\n        <li class=\"list-group-item\">Selected Products <button type=\"button\" *ngIf=\"selectedProducts.length\" class=\"btn btn-danger btn-sm pull-right\"\r\n            (click)=\"clearAddedProducts();\">Clear</button> </li>\r\n        <li class=\"list-group-item\" *ngFor=\"let product of selectedProducts; let i = index;\">\r\n          <div class=\"col-xs-12 fa fa-cubes\"> {{product.productName}}</div>\r\n          <span class=\"badge badge-danger badge-pill pull-right\" (click)=\"removeProduct(i);\"> - Remove</span>\r\n\r\n        </li>\r\n        <li class=\"list-group-item\" *ngIf=\"!selectedProducts.length\">\r\n          No products added\r\n        </li>\r\n      </ul>\r\n    </div>\r\n\r\n    <!--/.col-->\r\n  </div>\r\n  <!--/.row-->\r\n</div>"
